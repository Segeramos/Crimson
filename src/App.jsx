  ...
  return (
    <Router>
      <div className="min-h-screen bg-gradient-to-r from-black to-gray-700 text-orange-100 font-['Karla']">
            ...
            <div className="hidden md:flex items-center space-x-8 text-sm">
              {["/", "/about", "/projects", "/services", "/contact"].map((path, i) => (
                <NavLink
                  ...
                  to={path}
                  className={({ isActive }) =>
                    `hover:text-red-500 pb-1 ${isActive ? "border-b-2 border-red-500" : ""}`
                  }
                >
            ...
            >
              {["/", "/about", "/projects", "/services", "/contact"].map((path, i) => (
                <NavLink
                  ...
                  to={path}
                  className={({ isActive }) =>
                    `hover:text-red-400 text-lg font-semibold pb-1 ${isActive ? "border-b-2 border-red-500" : ""}`
                  }
        ...
        {/* Footer — outside container so it stretches full width */}
        <Footer />
