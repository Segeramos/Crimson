        ...
        <form ref={form} onSubmit={sendEmail} className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-1 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-orange-100 rounded px-3 py-2 mt-1 bg-transparent text-orange-100"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              required
              className="w-full border border-gray-300 rounded px-3 py-2 mt-1 bg-transparent text-orange-100"
            ></textarea>
          </div>

          <button
            type="submit"
            className="bg-red-800 hover:bg-red-700 text-orange-100 font-semibold py-2 px-8 rounded-full transition cursor-pointer"
          >
            Submit
          </button>
        </form>
